...
//        KFontUtil.tneufr.drawStringWithShadow("test", 100, 100, rbw);
  ...
  //      FontRenderer neufr = Minecraft.getMinecraft().fontRendererObj;
        ...
        if (Config.keystrokes) {
            /////////KEYSTROKES
            final int negroW = new Color(0, 1, 0, 100).getRGB();
            final int negroA = new Color(0, 0, 1, 100).getRGB();
            final int negroS = new Color(1, 0, 0, 100).getRGB();
            final int negroD = new Color(1, 0, 1, 100).getRGB();
            final int negro2 = new Color(255, 255, 255, 206).getRGB();
            final int negro21 = new Color(255, 255, 255, 205).getRGB();
            final int negro22 = new Color(255, 255, 255, 204).getRGB();
            final int negro23 = new Color(255, 255, 255, 203).getRGB();
            final int negro24 = new Color(255, 255, 255, 202).getRGB();
            final int negro25 = new Color(255, 255, 255, 201).getRGB();
            ...
            if (mc.gameSettings.isKeyDown(mc.gameSettings.keyBindForward)) {
                ...
                Gui.drawRect(100 +(-73+Config.keystrokesX), 100+(-100+Config.keystrokesY), 125+(-73+Config.keystrokesX), 125+(-100+Config.keystrokesY), negro21);
                neufr.drawStringWithShadow("W", 114+(-77+Config.keystrokesX), 106+(-97+Config.keystrokesY), xddddddddd4);

            } else {

                Gui.drawRect(100+(-73+Config.keystrokesX), 100+(-100+Config.keystrokesY), 125+(-73+Config.keystrokesX), 125+(-100+Config.keystrokesY), negroW);
            ...
            if (mc.gameSettings.isKeyDown(mc.gameSettings.keyBindLeft)) {
                ...
                Gui.drawRect(73+(-73+Config.keystrokesX), 127+(-100+Config.keystrokesY), 98+(-73+Config.keystrokesX), 152+(-100+Config.keystrokesY), negro22);
                neufr.drawStringWithShadow("A", 87+(-77+Config.keystrokesX), 133+(-97+Config.keystrokesY), xddddddddd4);

            } else {

                Gui.drawRect(73+(-73+Config.keystrokesX), 127+(-100+Config.keystrokesY), 98+(-73+Config.keystrokesX), 152+(-100+Config.keystrokesY), negroA);
            ...
            if (mc.gameSettings.isKeyDown(mc.gameSettings.keyBindBack)) {
                ...
                Gui.drawRect(100+(-73+Config.keystrokesX), 127+(-100+Config.keystrokesY), 125+(-73+Config.keystrokesX), 152+(-100+Config.keystrokesY), negro23);
                neufr.drawStringWithShadow("S", 114+(-77+Config.keystrokesX), 133+(-97+Config.keystrokesY), xddddddddd4);

            } else {

                Gui.drawRect(100+(-73+Config.keystrokesX), 127+(-100+Config.keystrokesY), 125+(-73+Config.keystrokesX), 152+(-100+Config.keystrokesY), negroS);
            ...
            if (mc.gameSettings.isKeyDown(mc.gameSettings.keyBindRight)) {
                ...
                Gui.drawRect(127+(-73+Config.keystrokesX), 127+(-100+Config.keystrokesY), 152+(-73+Config.keystrokesX), 152+(-100+Config.keystrokesY), negro24);
                neufr.drawStringWithShadow("D", 141+(-77+Config.keystrokesX), 133+(-97+Config.keystrokesY), xddddddddd4);

            } else {

                Gui.drawRect(127+(-73+Config.keystrokesX), 127+(-100+Config.keystrokesY), 152+(-73+Config.keystrokesX), 152+(-100+Config.keystrokesY), negroD);
