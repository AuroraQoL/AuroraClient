...
public class FontUtil {
    ...
    public FontUtil(final Font font) {
        this(font, 256);
    }

    public FontUtil(final Font font, final int characterCount) {
        this(font, characterCount, true);
    }

    public FontUtil(final Font font, final int characterCount, final boolean antiAlias) {
        this.font = font;
    ...
    public void drawCenteredWithShadowFromCustomFontRenderer(final FontRenderer fr, final String text, final float x, final float y2, final int color) {
        final float width = this.getWidth(text) / 2.0f;
        fr.drawStringWithShadow(text, x - width, y2, color);
    }
