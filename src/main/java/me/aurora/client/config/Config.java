...
public class Config extends Vigilant {
    ...
    @Property(
            type = PropertyType.NUMBER, name = "spx", category = "pos", hidden = true)
    public static int SPEED_X = 5;
    @Property(
            type = PropertyType.NUMBER, name = "spy", category = "pos", hidden = true)
    public static int SPEED_Y = 200;
    ////////////
    ////////////
    ////////////
    ...
    @Property(
            type = PropertyType.SWITCH,
            name = "Speed Graph Visibility",
            description = "",
            category = "HUD",
            subcategory = "Speed Graph"
    )
    public static boolean hudSpeedgraph = true;
